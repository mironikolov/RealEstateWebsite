...
export class UserService {
  ...
  public usersUrl:string = `${environment.SERVER_URL}/users`;
  public picturesUrl:string = `${environment.SERVER_URL}/pictures`;
  ...
  getUserImageUrl( userId: string ): Observable<SafeUrl>{
    return this.http.get( `${this.picturesUrl}/${userId}/${undefined}`,
